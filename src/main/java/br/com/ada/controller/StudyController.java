...
public class StudyController {
    private TasksService<StudyTask> service;

    public StudyController(TasksService<StudyTask> service) {
    ...
    private void createTask(Scanner scanner) {
        ...
        System.out.println("Digite a matéria relacionada a tarefa:");
        ...
        StudyTask task = new StudyTask(title, description, deadline, subject);
    ...
    private void editTask(Scanner scanner) {
        ...
        StudyTask task = service.findById(id);
        ...
        System.out.println("Digite a nova matéria relacionada a tarefa:");
